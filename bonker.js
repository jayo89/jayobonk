// Jayobonk BRIDGE Websocket Scripts
...
function connectBridge()
{
    ...
    {
        bridgeIsOpen = true;
        console.log("Connected to jayoBonk BRIDGE!");
        ...
        tryConnectBridge = setInterval(function()
        {
            ...
            {
                bridgeIsOpen = false;
                console.log("Lost connection to jayoBonk BRIDGE!");
                endCalibration();
                clearInterval(tryConnectBridge);
...
connectBridge();
// Retry connection to jayoBonk BRIDGE every 3 seconds
var tryConnectBridge = setInterval(retryConnectBridge, 1000 * 3);

function retryConnectBridge()
{
    console.log("Retrying connection to jayoBonk BRIDGE...");
    connectBridge();
}
